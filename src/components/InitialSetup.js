...
function InitialSetup() {
    ...
    const disabled =
        company.opening_time && company.closing_time ? true : false;
    return (
        <div className="InitialSetup">
            <div className="setupContainer">
                <div className="Introduction">
                    ...
                    <p>
                        Estaré ayudándote para que puedas hacer la correcta
                        genstión a tu negocio.
                    </p>
                ...
                <div className="setupButtons">
                    <button
                        onClick={() => {
                            const checkHourly =
                                company.opening_time !== null &&
                                company.closing_time !== null;
