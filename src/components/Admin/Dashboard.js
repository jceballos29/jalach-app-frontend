...
function Dashboard({ dateTime }) {
    ...
    let hourStandard =
        dateTime.hours > 12 ? dateTime.hours - 12 : dateTime.hours;
            ...
            setPIList(
                employeesPayroll.map((element) => {
                    const role = roles.find(
                        (role) => role.id === element.role_id
                    );
                    return (
                        <div
                            key={element.employee}
                            className="PIitem"
            ...
            <div className="DashboardContent">
                <div className="dashboardContainer">
                    <div className="payrollInfo box">
                        ...
                        <div className="PIBody">{PIList}</div>
                    </div>
                    ...
                    <div className="payrollGraph box">
                        ...
                        <div className="PGBody">{PGList}</div>
                    </div>
                    ...
                    <div className="inventoryGraph box">
                        ...
                        <div className="IGBody">{BCList}</div>
                    </div>
                </div>
            </div>
        </div>
